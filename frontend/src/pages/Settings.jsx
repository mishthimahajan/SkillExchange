...
//   return (
//     <div className="min-h-screen flex items-center justify-center bg-blue-200 relative">
...
//     try {
//       setLoading(true);
//       const token = localStorage.getItem('token'); // if you are using JWT auth
...
//             required
//           />
//           <button type="submit" disabled={loading} className="bg-indigo-600 hover:bg-indigo-700 text-black p-3 rounded-lg font-semibold transition-transform hover:scale-105 duration-200">
...
function Settings() {
  ...
  // Update password via POST request
  const handlePasswordUpdate = async (e) => {
  e.preventDefault();
  ...
  try {
    ...
    console.log("Stored token:", token); // <-- check here
